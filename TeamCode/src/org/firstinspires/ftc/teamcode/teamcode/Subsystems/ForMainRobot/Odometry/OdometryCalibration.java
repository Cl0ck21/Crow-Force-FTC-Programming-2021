...
public class OdometryCalibration extends LinearOpMode {
    ...
    File wheelBaseSeparationFile = new File("wheelBaseSeparation.txt");
    File horizontalTickOffsetFile = new File("horizontalTickOffset.txt");
    ...
    public void runOpMode() throws InterruptedException {
       ...
       */
        ...
        HALFileUtil.save(wheelBaseSeparationFile.getAbsolutePath(), String.valueOf(wheelBaseSeparation));
        HALFileUtil.save(horizontalTickOffsetFile.getAbsolutePath(), String.valueOf(horizontalTickOffset));
