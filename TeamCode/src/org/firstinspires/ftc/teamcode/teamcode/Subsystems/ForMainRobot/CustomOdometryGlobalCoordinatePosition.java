 ...
 */
public class CustomOdometryGlobalCoordinatePosition extends SubSystem {
    //Odometry wheels
    ...
    private File wheelBaseSeparationFile = new File("wheelBaseSeparation.txt");
    private File horizontalTickOffsetFile = new File("horizontalTickOffset.txt");
     ...
     */
    public CustomOdometryGlobalCoordinatePosition(Robot r, String verticalEncoderLeft, String verticalEncoderRight, String horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
        super(r);
        this.verticalEncoderLeft = robot.hardwareMap.dcMotor.get(verticalEncoderLeft);
        this.verticalEncoderRight = robot.hardwareMap.dcMotor.get(verticalEncoderRight);
        this.horizontalEncoder = robot.hardwareMap.dcMotor.get(horizontalEncoder);
        sleepTime = threadSleepDelay;

        robotEncoderWheelDistance = Double.parseDouble(HALFileUtil.readFile(wheelBaseSeparationFile.getAbsolutePath()).trim()) * COUNTS_PER_INCH;
        this.horizontalEncoderTickPerDegreeOffset = Double.parseDouble(HALFileUtil.readFile(horizontalTickOffsetFile.getAbsolutePath()).trim());
